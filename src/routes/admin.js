...
router.post('/guests/:id/points', (req, res) => {
  ...
  // It IS clamped at 0 by stmtAddBonus's UPDATE (MAX(0, ...)) — a large negative
  // delta cannot drive a guest's bonus below zero. The admin sees the running total in the UI.
